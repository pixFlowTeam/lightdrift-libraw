...
try {
    ...
    try {
        ...
        execSync('git commit -m "feat: initial LibRaw Node.js implementation\n\n- Native addon for RAW image processing\n- Comprehensive metadata extraction\n- Promise-based API\n- Sample tests and examples\n- GitHub-ready project structure"', { stdio: 'inherit' });
    ...
    console.log('   git remote add origin https://github.com/yourusername/libraw-node.git');
