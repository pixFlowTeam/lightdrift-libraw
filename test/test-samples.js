    ...
    try {
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            try {
                ...
                console.log(`🎯 Settings: ISO ${metadata.iso}, f/${metadata.aperture?.toFixed(1)}, 1/${Math.round(1/metadata.shutterSpeed)}s, ${metadata.focalLength}mm`);
                ...
                console.log(`🎨 Color filter: 0x${filterHex} (${metadata.colors} colors)`);
